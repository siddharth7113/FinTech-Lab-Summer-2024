...
OUTPUT_DIR = 'src/analysis/text-summaries'
REQUEST_INTERVAL = 10  # Interval in seconds between requests to manage API rate limit

def make_request(text_content):
    prompt = """
    Provide a year-wise breakdown of the most critical financial events and 
    their impacts on the company's performance. Include brief insights into how these events 
    influenced revenue and profitability.
    (Make sure it includes information for the years available between 2000 to 2023)"
    """
    headers = {
